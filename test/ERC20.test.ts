...
} = require("./ERC20.behavior.ts");

const ERC20Mock = artifacts.require("ERC20MockUpgradeableWithInit");
const ERC20DecimalsMock = artifacts.require(
...
contract("ERC20Upgradeable", function (accounts) {
  ...
  describe("_burn", function () {
    ...
    describe("for a non zero account", function () {
      ...
      const describeBurn = function (description: any, amount: any) {
  ...
  describe("_transfer", function () {
    shouldBehaveLikeERC20Transfer(
      ...
      recipient,
      initialSupply,
      function (this: any, from: any, to: any, amount: any) {
  ...
  describe("_approve", function () {
    shouldBehaveLikeERC20Approve(
      ...
      recipient,
      initialSupply,
      function (this: any, owner: any, spender: any, amount: any) {
